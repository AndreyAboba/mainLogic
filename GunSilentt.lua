...
local function updateFovCircle(deltaTime)
    ...
    if GunSilent.Settings.GradientCircle.Value then
        ...
        local color1 = GunSilent.Watermark.Settings.gradientColor1
        local color2 = GunSilent.Watermark.Settings.gradientColor2
...
local function Init(UI, Core, notify)
    ...
    if success and result and type(result) == "table" then
        ...
        if WatermarkModule.Init and type(WatermarkModule.Init) == "function" then
            WatermarkModule.Init(UI, Core, notify)
        end
    end
    GunSilent.Watermark = WatermarkModule or { Settings = { gradientColor1 = Color3.fromRGB(255, 255, 255), gradientColor2 = Color3.fromRGB(255, 255, 255) } }
